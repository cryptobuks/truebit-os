...
node ~/truebit-os/emscripten-module-wrapper/prepare.js scrypt.js --debug --run --file input.data --file output.data --memory-size 20 --out=stuff --metering=5000 --upload-ipfs --limit-stack
